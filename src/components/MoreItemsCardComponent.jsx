...
const MoreItemsCardComponent = ({ title, imgSrc, description, price}) => {
    ...
    return (
        <Col md={4} className={"w-25 h-25"}>
            <Card className={"m-2 border-3 border-opacity-100 border-dark rounded-5"}>
                ...
                <Card.Img
                    src={imgSrc}
                    className="pendrive_muestra_8bits w-75 mx-auto d-block rounded-3 border-2 border-dark shadow-lg"
                />
                <Card.Body>
                ...
                <Card.Footer className="d-flex justify-content-center align-content-center gap-3">
                    <Button
                        ...
                        className={"justify-content-center align-content-center w-25"}>+1💰
                    </Button>
                    <h3 className='fw-bolder mt-2 cartNumber'> {count} </h3>
                    <Button
                        onClick={() => setCount(prevCount => Math.max(0, prevCount - 1))}
                        className={"justify-content-center align-content-center w-25"}>
                        <span>-1💰</span>
                    </Button>
                </Card.Footer>
                <Card.Footer className="d-flex justify-content-center align-content-center gap-3">
...
export default MoreItemsCardComponent